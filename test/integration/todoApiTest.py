...
class TestApi(unittest.TestCase):
    ...
    def test_api_gettodo(self):
        ...
        self.assertEqual(
            jsonbody['text'], "Integration text example - GET",
            "Error en la petición API a {url}"
        )
        # Test GET TODO
        ...
        self.assertEqual(
            json_response['text'], "Integration text example - GET",
            "Error en la petición API a {url}"
        )
    ...
    def test_api_updatetodo(self):
        ...
        self.assertEqual(
            jsonbody['text'], "Integration text example - Initial",
            "Error en la petición API a {url}"
        )
        # Update TODO
        url = BASE_URL+"/todos/" + ID_TODO
        ...
        self.assertEqual(
            json_response['text'], "Integration text example - Modified",
            "Error en la petición API a {url}"
        )
        # Test GET TODO
        url = BASE_URL+"/todos/"+ID_TODO
